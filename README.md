...
```css
filter: invert(42%) sepia(0%) saturate(6%) hue-rotate(202deg) brightness(95%) contrast(
    92%
  );
```
...
_To calculate these values, use the following tool_
...
**_[LINK TO MY DEPLOYED PROJECT ON GITHUB PAGE](https://cristian-h97.github.io/se_project_spots/)_**

**_[LINK TO MY DEPLOYED PROJECT ON YOUTUBE PAGE](https://youtu.be/GXxJlqoPoeY?si=-qbuPrlb8ECR_DwB)_**
...
```css
filter: invert(42%) sepia(0%) saturate(6%) hue-rotate(202deg) brilliant(95%) contrast(
    92%
  );
```
...
_Para calcular estos valores, utiliza la siguiente herramienta_
...
**_[ENLACE A MI PROYECTO IMPLEMENTADO EN LA PÁGINA DE GITHUB](https://cristian-h97.github.io/se_project_spots/)_**
